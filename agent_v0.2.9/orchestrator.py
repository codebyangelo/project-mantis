...
from agent import MantisAgent, AgentCommand
...
def generate_mitre_report(results: list, agent_system=None):
    ...
    report_content = f"""# Project Mantis (v0.2.9) - Autonomous DFIR Report
...
def main():
    ...
    print(f"\033[96m[ PROJECT MANTIS - V0.2.9 ({mode_str}) ]\033[0m")
    print("------------------------------------------------------------")
