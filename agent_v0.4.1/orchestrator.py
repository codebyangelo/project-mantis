...
def run_fsm_loop(chat_session, agent_system=None):
    ...
    for ent in entities:
        ...
        try:
            ...
            # ClaimGuard Check
            inference_bans = [r'\bintent\b', r'\blikely\b', r'\bsuggests\b', r'\bimplies\b', r'\bindicates\b', r'\bmeaning of\b', r'\bresignation\b', r'\bsensitive\b', r'\bstaging\b', r'\bmotive\b', r'\bmay have\b', r'\bcould be\b', r'\bpossible\b', r'\bpossibly\b', r'\bsuspect\b', r'\bguess\b', r'\bassume\b']
