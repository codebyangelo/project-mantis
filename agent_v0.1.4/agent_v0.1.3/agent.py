...
class FindEvilAgent:
    def __init__(self):
        ...
        [CRITICAL OVERRIDE] You are the Universal Forensic Engine (v0.1.3). You are a deterministic state machine. You do not skip steps. You do not make assumptions.
        ...
        - Step E: Call `carve_memory_strings` passing "NETWORK" as the regex_pattern to extract strict, routable IPv4 addresses from the physical memory image.
