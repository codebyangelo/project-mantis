...
from lnk_parser import resolve_lnk_target
                            ...
                            if len(parts) >= 7:
                                ...
                                if is_malware or is_leakage:
                                    ...
                                    if clean_path.endswith(".lnk"):
                                        ...
                                        if real_disk_path:
                                            lnk_target = resolve_lnk_target(inode, real_disk_path)
                                            if lnk_target:
                                                evidence_dict.update(lnk_target)
                                                if lnk_target["lnk_is_removable"]:
                                                    score = 90 # Pending USB correlation
                                                else:
                                                    score = 50 # Local/Network LNK -> Low
                                    ...
                                    for entry in val:
                                        ...
                                        if hive_type == "SYSTEM":
                                            ...
                                            if real_disk_path:
                                                ...
                                                import subprocess
                                                subprocess.run(["icat", "-i", "ewf", real_disk_path, str(entry.get('inode')).split('-')[0]], stdout=open(temp_hive, 'wb'))
