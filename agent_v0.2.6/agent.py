...
class FindEvilAgent:
    def __init__(self):
        ...
        You are the Universal Forensic Engine (v0.2.6). 
    ...
    def synthesize_investigation(self, isolated_threats: list) -> ExecutiveSynthesis:
        ...
        config = types.GenerateContentConfig(
            system_instruction="You are a Lead Forensic Investigator (v0.2.6). Synthesize triage data into a cohesive incident report.",
            temperature=0.2,
            response_mime_type="application/json",
