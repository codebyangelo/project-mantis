...
def run_fsm_loop(chat_session, agent_system=None):
    ...
    for ent in entities:
        ...
        if "SIG_RWX_INJECTION" in ent.get('signals', []):
            deterministic_verdict = type('obj', (object,), {'verdict': 'MALICIOUS', 'reasoning': 'Deterministic SIG_RWX_INJECTION proven by sieve.'})()
